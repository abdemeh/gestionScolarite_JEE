...
<main>
    ...
    <div class="container">
        <table>
            ...
            <tbody>
            <%
                List<springboot.modelesringboot.Enseignant> professeurs = (List<springboot.modelesringboot.Enseignant>) request.getAttribute("professeurs");
                if (professeurs != null && !professeurs.isEmpty()) {
                    for (springboot.modelesringboot.Enseignant professeur : professeurs) {
            %>
            <tr>
