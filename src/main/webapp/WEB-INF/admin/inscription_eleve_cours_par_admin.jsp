...
<div style="display: flex; justify-content: space-between;">
    ...
    <div style="width: 45%; border: 1px solid #ccc; padding: 15px;">
        ...
        <table border="1" cellpadding="10" style="width: 100%;">
            ...
            <tbody>
            <%
                List<springboot.modelesringboot.InscriptionCours> inscriptions = (List<springboot.modelesringboot.InscriptionCours>) request.getAttribute("inscriptions");
                if (inscriptions != null && !inscriptions.isEmpty()) {
                    for (springboot.modelesringboot.InscriptionCours inscription : inscriptions) {
            %>
            <tr>
    ...
    <div style="width: 45%; border: 1px solid #ccc; padding: 15px;">
        ...
        <%
            springboot.modelesringboot.Etudiant etudiant = (springboot.modelesringboot.Etudiant) request.getAttribute("searchEtudiant");
            if (etudiant != null) {
        %>
        ...
        <%
            List<springboot.modelesringboot.Cours> cours = (List<springboot.modelesringboot.Cours>) request.getAttribute("cours");
        ...
        <form action="inscrireCours" method="post" style="margin-top: 20px;">
            ...
            <select name="id_cours" id="selectCours" required>
                <%
                    for (springboot.modelesringboot.Cours lecours : cours) {
                %>
